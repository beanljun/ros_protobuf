...
int main(int argc, char **argv) {
  ...
  ros::Publisher pub =
      n.advertise<bean::sample::PublishInfo>("/protochat", 1000);

  ros::Rate loop_rate(10);
  
  bean::sample::PublishInfo proto_msg_info;
  proto_msg_info.set_name("LOVE");
  proto_msg_info.set_message_type("test_message");
  proto_msg_info.set_publish_msg("Love is in the air");
